	...
	<div class="card-body">
		...
		<div class="row">
			...
			<div class="col-md-6 trendsearch_box ">
				...
				<!--		キーワードランダム							-->
				<div class="togglebutton keyword_disp_box" style="margin-bottom: 15px">
					<label>
						<input type="checkbox" name="is_keyword_shuffle" value="1" id="input_iskeywordshuffle" <?php if($appuser["is_keyword_shuffle"] == 1) echo "checked" ?> <?= $readOnly ?> >
						<span class="toggle"></span>
						検索キーワードをシャッフル
						<span id="input_iskeywordshuffle_text"></span>
					</label>
				</div>
				...
				<div class="form-group ranking_disp_box">
					<label for="exampleInputPassword1">トレンドのジャンル</label>
			...
			<div class="col-md-6">
				<div class="form-group">
					<label for="exampleInputPassword1">リツイート数 (/ランキング)</label>
			...
			<div class="col-md-12 wasshoirate_box">
				<div class="form-group" style="margin-top: 0px">
					...
					<div class="wrap between">
						...
						<small class="guage-label text-muted">貢献する（自分はいいねされない） →</small>
					</div>
